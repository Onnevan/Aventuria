...
function renderObjectProps(obj) {
  ...
  const occ = typeof ensureOcclusionConfig === "function" ? ensureOcclusionConfig(obj) : (obj.occlusion ??= { enabled: obj.type !== "background", mode: "footprint", offsetY: 0 });
